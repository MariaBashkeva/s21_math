...
START_TEST(s21_atan_test) {
  ...
  ck_assert_ldouble_eq_tol(s21_atan(S21_INF_POS), atan(S21_INF_POS),
                           S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_atan(S21_INF_NEG), atan(S21_INF_NEG),
                           S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_atan(100), atan(100), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_atan(-100), atan(-100), S21_EPSILON);
...
START_TEST(s21_cos_test) {
  ...
  ck_assert_ldouble_eq_tol(s21_cos(0.0), cos(0.0), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_cos(20), cos(20), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_cos(-0.5), cos(-0.5), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_cos(-1), cos(-1), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_cos(1), cos(1), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_cos(-2), cos(-2), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_cos(2), cos(2), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_cos(-1000000), cos(-1000000), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_cos(10000000000), cos(10000000000), S21_EPSILON);
  ck_assert_ldouble_nan(s21_cos(S21_INF_POS));
  ck_assert_ldouble_nan(s21_cos(S21_INF_NEG));
  ck_assert_ldouble_eq_tol(s21_cos(-1.2), cos(-1.2), S21_EPSILON);
}
END_TEST

START_TEST(s21_exp_test) {
  ck_assert_ldouble_eq_tol(s21_exp(0), exp(0), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_exp(0.0), exp(0.0), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_exp(0.5), exp(0.5), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_exp(-0.5), exp(-0.5), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_exp(-1), exp(-1), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_exp(1), exp(1), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_exp(10), exp(10), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_exp(0.00000001), exp(0.00000001), S21_EPSILON);
  ck_assert_ldouble_eq(s21_exp(12345.6789), exp(12345.6789));
  ck_assert_ldouble_eq(s21_exp(-12345.6789), exp(-12345.6789));
...
START_TEST(s21_sin_test) {
  ...
  ck_assert_ldouble_eq_tol(s21_sin(0.0), sin(0.0), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_sin(0.5), sin(0.5), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_sin(-0.5), sin(-0.5), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_sin(-1), sin(-1), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_sin(1), sin(1), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_sin(-3), sin(-3), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_sin(3), sin(3), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_sin(1000), sin(1000), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_sin(-1000), sin(-1000), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_sin(-1000000), sin(-1000000), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_sin(-1.2), sin(-1.2), S21_EPSILON);
}
END_TEST
...
START_TEST(s21_sqrt_test) {
  ...
  ck_assert_ldouble_eq_tol(s21_sqrt(2.5), sqrt(2.5), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_sqrt(0.6), sqrt(0.6), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_sqrt(34.9), sqrt(34.9), S21_EPSILON);
...
START_TEST(s21_tan_test) {
  ...
  ck_assert_ldouble_eq_tol(s21_tan(-1.2), tan(-1.2), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_tan(1.2), tan(1.2), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_tan(-1000000), tan(-1000000), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_tan(999999), tan(999999), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_tan(10000), tan(10000), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_tan(-10000), tan(-10000), S21_EPSILON);
...
START_TEST(s21_log_test) {
  ...
  ck_assert_ldouble_eq_tol(s21_log(1.43), log(1.43), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_log(2.73), log(2.73), S21_EPSILON);
}
END_TEST
...
START_TEST(s21_fmod_test) {
  ...
  ck_assert_ldouble_nan(s21_fmod(0.0, S21_NAN));
  ck_assert_ldouble_nan(s21_fmod(0.0, 0.0));
  ck_assert_ldouble_eq_tol(s21_fmod(3.345, 5), fmod(3.345, 5), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_fmod(-1.65, S21_INF_POS),
                           fmod(-1.65, S21_INF_POS), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_fmod(-1.0004, S21_INF_NEG),
                           fmod(-1.0004, S21_INF_NEG), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_fmod(0.0, 34.5), fmod(0.0, 34.5), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_fmod(3.345, S21_INF_POS),
                           fmod(3.345, S21_INF_POS), S21_EPSILON);
...
START_TEST(s21_pow_test) {
  ...
  ck_assert_ldouble_eq_tol(s21_pow(0.0, 0.0), pow(0.0, 0.0), S21_EPSILON);
  ck_assert_ldouble_eq(s21_pow(0.0, -2.0), pow(0.0, -2.0));
  ck_assert_ldouble_eq_tol(s21_pow(0.0, 3.0), pow(0.0, 3.0), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_pow(0.0, 4.0), pow(0.0, 4.0), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_pow(0, S21_INF_POS), pow(0, S21_INF_POS),
                           S21_EPSILON);
  ck_assert_ldouble_eq(s21_pow(0, S21_INF_NEG), pow(0, S21_INF_NEG));
  ...
  ck_assert_ldouble_eq_tol(s21_pow(-1.0, S21_INF_NEG), pow(-1.0, S21_INF_NEG),
                           S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_pow(1.0, S21_NAN), pow(1.0, S21_NAN),
                           S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_pow(1.0, -3.0), pow(1.0, -3.0), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_pow(1.0, -2.0), pow(1.0, -2.0), S21_EPSILON);
  ...
  ck_assert_ldouble_eq_tol(s21_pow(S21_INF_NEG, 0.0), pow(S21_INF_NEG, 0.0),
                           S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_pow(S21_NAN, 0.0), pow(S21_NAN, 0.0),
                           S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_pow(2.75, 0.0), pow(2.75, 0.0), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_pow(-1.3, 0.0), pow(-1.3, 0.0), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_pow(2, 2), pow(2, 2), S21_EPSILON);
  ck_assert_ldouble_nan(s21_pow(-1.3, 1.2));
  ck_assert_ldouble_eq_tol(s21_pow(0, 5), pow(0, 5), S21_EPSILON);
  ck_assert_ldouble_nan(s21_pow(-1.0, -1.2));
  ck_assert_ldouble_eq_tol(s21_pow(-2, 2), pow(-2, 2), S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_pow(-3, 2), pow(-3, 2), S21_EPSILON);
  ck_assert_ldouble_eq(s21_pow(-0.5, S21_INF_NEG), pow(-0.5, S21_INF_NEG));
  ck_assert_ldouble_eq_tol(s21_pow(-1.5, S21_INF_NEG), pow(-1.5, S21_INF_NEG),
                           S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_pow(1.3, S21_INF_NEG), pow(1.3, S21_INF_NEG),
                           S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_pow(2.0, S21_INF_NEG), pow(2.0, S21_INF_NEG),
                           S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_pow(-2.3, S21_INF_NEG), pow(-2.3, S21_INF_NEG),
                           S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_pow(0.4, S21_INF_POS), pow(0.4, S21_INF_POS),
                           S21_EPSILON);
  ck_assert_ldouble_eq_tol(s21_pow(-0.2, S21_INF_POS), pow(-0.2, S21_INF_POS),
                           S21_EPSILON);
  ...
  ck_assert_ldouble_eq(s21_pow(-3.0, S21_INF_POS), pow(-3.0, S21_INF_POS));
  ck_assert_ldouble_eq(s21_pow(-2.32, S21_INF_POS), pow(-2.32, S21_INF_POS));
  ...
  ck_assert_double_eq(s21_pow(0, 15), pow(0, 15));
  ck_assert_double_eq_tol(s21_pow(1, S21_INF_NEG), pow(1, S21_INF_POS),
                          S21_EPSILON);
